...
<article>
  ...
  <section id="S1" class="ltx_section">
    ...
    <div id="S1.p1" class="ltx_para">
      <p class="ltx_p">Despite decades of visualization research and recent legal requirements to make web-based content accessible&nbsp;<cite class="ltx_cite ltx_citemacro_cite">[<span class="ltx_ref ltx_missing_citation ltx_ref_self">w3c_web_2018</span>, <span class="ltx_ref ltx_missing_citation ltx_ref_self">higgins_supreme_2019</span>]</cite>, web-based visualizations remain largely inaccessible to people with visual disabilities.
  ...
  <section id="S2" class="ltx_section">
    ...
    <div id="S2.p2" class="ltx_para">
      <p class="ltx_p"><strong class="ltx_text ltx_font_bold">Web Accessibility Standards.</strong>
        ...
        In 2018, the W3C published the WAI-ARIA Graphics Module&nbsp;<cite class="ltx_cite ltx_citemacro_cite">[<span class="ltx_ref ltx_missing_citation ltx_ref_self">w3c_wai-aria_2018</span>]</cite> with additional attributes to support marking up structured graphics such as charts, maps, and diagrams.
    ...
    <div id="S2.p4" class="ltx_para">
      <p class="ltx_p">There has been some promising progress for improving support for accessibility within visualization toolkits, and vice-versa for improving native support for charts in screen reader technologies.
        For instance, Vega-Lite&nbsp;<cite class="ltx_cite ltx_citemacro_cite">[<span class="ltx_ref ltx_missing_citation ltx_ref_self">satyanarayan_vega-lite_2017</span>]</cite> and Highcharts&nbsp;<cite class="ltx_cite ltx_citemacro_cite">[<span class="ltx_ref ltx_missing_citation ltx_ref_self">highcharts_accessibility_2021</span>]</cite> are beginning to provide ARIA support out-of-the-box.
        ...
        We go beyond what ARIA supports today to enable high-level and fine-grained screen reader interactions, and hope that our work will help inform ongoing discussions on improving web accessibility standards (e.g., via an Accessibility Object Model&nbsp;<cite class="ltx_cite ltx_citemacro_cite">[<span class="ltx_ref ltx_missing_citation ltx_ref_self">boxhall_accessibility_2022</span>]</cite>).
      </p>
    </div>
  </section>
  <section id="S3" class="ltx_section">
    ...
    <div id="S3.p2" class="ltx_para">
      <p class="ltx_p"><strong class="ltx_text ltx_font_bold">Methods.</strong>
        ...
        To balance engaging disabled users while acknowledging academia’s traditionally extractive relationship with marginalized populations&nbsp;<cite class="ltx_cite ltx_citemacro_cite">[<span class="ltx_ref ltx_missing_citation ltx_ref_self">cornwall_what_1995</span>]</cite>, we intentionally acknowledge <span class="ltx_ERROR undefined">\censor</span>Hajas as both co-designer and co-author.
    ...
    <section id="S3.SS1" class="ltx_subsection">
      ...
      <figure id="S3.F1" class="ltx_figure"><img src="x3.png" id="S3.F1.g1" class="ltx_graphics ltx_centering" width="1081" height="333" alt="">
    ...
    <section id="S3.SS3" class="ltx_subsection">
      ...
      <div id="S3.SS3.p5" class="ltx_para">
        <p class="ltx_p"><strong class="ltx_text ltx_font_bold">Verbosity.</strong>
          ...
          For instance, JAWS offers high, medium, and low verbosity levels&nbsp;<cite class="ltx_cite ltx_citemacro_cite">[<span class="ltx_ref ltx_missing_citation ltx_ref_self">freedom_scientific_jaws_2021</span>]</cite>.
  ...
  <section id="S4" class="ltx_section">
    ...
    <figure id="S4.F2" class="ltx_figure"><img src="x4.png" id="S4.F2.g1" class="ltx_graphics ltx_centering" width="1081" height="308" alt="">
    ...
    <section id="S5.SS1" class="ltx_subsection">
      ...
      <div id="S5.SS1.p5" class="ltx_para">
        <p class="ltx_p"><strong class="ltx_text ltx_font_bold">Participants.</strong>
          ...
          These figures are consistent with recent surveys conducted by WebAIM which indicate that JAWS, NVDA, and VoiceOver are the three most commonly used screen readers&nbsp;<cite class="ltx_cite ltx_citemacro_cite">[<span class="ltx_ref ltx_missing_citation ltx_ref_self">webaim_screen_2021</span>]</cite>. Demographically, 70% of our participants use he/him pronouns (n=9) and the rest use she/her pronouns (n=4).
